...
import { Box, Breadcrumbs, Typography, Button, Paper } from "@mui/material";
import Grid from '@mui/material/Grid2';
import Link from 'next/link';
import { CreateNewFolder, ArrowBack, Home as HomeIcon, Folder } from '@mui/icons-material';
...
const DirectoryView: React.FC<DirectoryViewProps> = ({ directoryId }) => {
  ...
  // Apply sorting
  const sortedDocuments = sortDocuments(childDocuments, sortValue.key, sortValue.direction);
